                ...
                child: TextFormField(
                  ...
                  onTap: () async {
                    ...
                    if (selectedadress != null) {
                      print(selectedadress?['x']);
                      print(selectedadress?['y']);
                      setState(() {
                      ...
                      if (selectedadress != null) {
                        ...
                        if (UserFirebase().createUserInfo(
                            ...
                            user: UserInfoModel.fromJson({
                              ...
                              "NLatLng": [selectedadress!['x'], selectedadress!['y']]
                            })) !=
                            null) {
                          print("성공?");
                        }
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('주소를 선택해주세요')));
                      }
                      setState(() {
